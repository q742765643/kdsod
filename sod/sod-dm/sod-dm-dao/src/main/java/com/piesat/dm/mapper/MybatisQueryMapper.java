...
public interface MybatisQueryMapper {
    ...
    List<Map<String, Object>> findArrivedDataCount(@Param("beginTime")String beginTime,@Param("endTime")String endTime);

    List<Map<String, Object>> findArrivedDataList();

    List<Map<String, Object>> querySql(@Param("dataSql") String dataSql);

    Map<String,Object> queryMinTime(@Param("params") Map<String, Object> map);

    Map<String,Object> queryMaxTime(@Param("params") Map<String, Object> map);

    Map<String,Object> queryRecordNum(@Param("params") Map<String, Object> map);
