...
public interface DatabaseDcl {
    ...
    ResultT queryData(String schema,String tableName, List<String> column,int pageNum,int pageSize) throws Exception;
     ...
     * @throws Exception
     */
    List<Map<String,Object>> querySql(List<String> column, String querySql) throws Exception;
