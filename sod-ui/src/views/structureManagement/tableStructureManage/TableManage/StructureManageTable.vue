              ...
              >
                ...
                <el-collapse class="collapseCon el-col el-col-24">
                  <el-collapse-item class="floor">
                    <template slot="title">
                      <i id="PathStatistics" class="el-icon-price-tag"></i
                      >路径统计
                    </template>
                    <div>
                      <path-statistics
...
/*路径统计*/
import PathStatistics from "@/views/structureManagement/tableStructureManage/TableManage/PathStatistics";
/*样例数据查询*/
...
export default {
  components: {
    ...
    "path-statistics": PathStatistics,
