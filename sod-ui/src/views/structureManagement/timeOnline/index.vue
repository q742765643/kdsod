<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="END_TIME" label="结束时间" width="150" sortable="custom"></el-table-column>
      <el-table-column prop="RECORD_COUNT" label="数据总量" width="150"></el-table-column>
