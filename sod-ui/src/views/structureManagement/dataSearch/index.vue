...
<script>
//分类树
import StructureClassify from "@/views/structureManagement/dataSearch/StructureClassify";
//表结构管理--弹出层
import StructureManageTable from "@/views/structureManagement/dataSearch/StructureManageTable";
import {
  dataClassAll,
  databaseClass,
  logicClass,
