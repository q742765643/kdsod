...
// 路径信息统计
export function pathstatisticsList(query) {
  return request({
    url: baseUrl + '/dm/dataSearch/selectPathStatistics',
    method: 'post',
    params: query
  })
}
...
// 数据动态查询
export function dataSearchList(data) {
  return request({
    url: baseUrl + '/dm/dataSearch/search',
    method: 'post',
    data: data
  })
}
...
export function deleteData(data) {
  return request({
    url: baseUrl + '/dm/dataSearch/deleteData',
    method: 'post',
    data: data
  })
}
...
export function updateData(data) {
  return request({
    url: baseUrl + '/dm/dataSearch/updateData',
    method: 'post',
    data: data
  })
}
